...
Nhớ **share cả file Sheet chấm công này và thư mục Drive ảnh** cho đúng `client_email` của service account (quyền Editor) — dùng chung 1 service account với phần đăng nhập, không cần tạo thêm.
